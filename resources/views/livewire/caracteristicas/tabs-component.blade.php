    ...
    @mobile
        @if ($caracteristica != null)
            @if ($tab == 'tab1')
                ...
                @livewire('caracteristicas.create')
            @elseif ($tab == 'tab2')
                <div style="border-bottom: 1px solid black !important;">
                    @if (
                        (Request::session()->get('inmobiliaria') == 'sayco' && Auth::user()->inmobiliaria === 1) ||
                ...
                @livewire('caracteristicas.edit', ['identificador' => $caracteristica], key('tab2'))
            @elseif ($tab == 'tab3')
                <div style="border-bottom: 1px solid black !important;">
                    @if (
                        (Request::session()->get('inmobiliaria') == 'sayco' && Auth::user()->inmobiliaria === 1) ||
                ...
                @livewire('caracteristicas.index')
            @elseif ($tab == 'tab4')
                <div style="border-bottom: 1px solid black !important;">
                    @if (
                        (Request::session()->get('inmobiliaria') == 'sayco' && Auth::user()->inmobiliaria === 1) ||
                ...
                <div class="ms-auto col d-grid gap-2">
                    <a class="btn btn-primary btn-lg" href="{{ route('inmuebles.index') }}"> Return to properties section
                    </a>
                </div>
            @endif
        @else
    ...
    @elsemobile
        @if ($caracteristica != null)
            ...
            @elseif ($tab == 'tab2')
                ...
                @livewire('caracteristicas.edit', ['identificador' => $caracteristica], key('tab3'))
